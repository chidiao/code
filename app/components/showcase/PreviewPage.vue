...
<template>
  <section class="card overflow-hidden">
    <div class="flex items-center gap-3 border-b border-slate-800 bg-slate-950/60 px-4 py-2.5">
      ...
      <div class="flex flex-1 items-center gap-2 rounded-md bg-slate-800/80 px-3 py-1">
